...
// Recupera album
$query = "SELECT DISTINCT al.id, al.titolo, al.immagine 
          FROM WBM_album al
          JOIN WBM_brano b ON al.id = b.id_album
          JOIN WBM_utente_brani ub ON b.id = ub.id_brano
          WHERE ub.id_utente = ?";
...
// Recupera brani
$query = "SELECT b.id, b.titolo, b.mp3, al.titolo AS album, a.nome AS artista
          FROM WBM_brano b
                        ...
                        <div class="container mx-4 my-4">
                                ...
                                <?php foreach ($artists as $artist): ?>
                                    <div class="col-4 col-md-3 col-lg-2">
                                        <div class="card h-100">
                                            <img src="../artistimg/<?php echo htmlspecialchars($artist['immagine']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($artist['nome']); ?>">
                                            <div class="card-body">
                            ...
                            <div class="row flex-nowrap overflow-auto mb-4">
                                <?php foreach ($albums as $album): ?>
                                    <div class="col-4 col-md-3 col-lg-2">
                                        <div class="card h-100">
                                            <img src="../albumimg/<?php echo htmlspecialchars($album['immagine']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($album['titolo']); ?>">
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo htmlspecialchars($album['titolo']); ?></h5>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="row flex-nowrap overflow-auto mb-4">
                                <?php foreach ($tracks as $track): ?>
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo htmlspecialchars($track['titolo']); ?></h5>
                                                <p class="card-text text-white"><strong>Album</strong>: <?php echo htmlspecialchars($track['album']); ?></p>
                                                <p class="card-text text-white"><strong>Artista</strong>: <?php echo htmlspecialchars($track['artista']); ?></p>
                                                <audio controls>
                                                    <source src="../mp3/<?php echo htmlspecialchars($track['mp3']); ?>" type="audio/mpeg">
